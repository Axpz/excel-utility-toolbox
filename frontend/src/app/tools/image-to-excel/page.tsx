...
import { ImageIcon, ArrowLeft, Clock, Sparkles } from "lucide-react";
import { Card, CardContent, CardDescription, CardHeader, CardTitle } from "@/components/ui/card";
import { Button } from "@/components/ui/button";
import { Badge } from "@/components/ui/badge";

export const metadata = {
  title: "Image to Excel - Coming Soon | Excel Utility Toolbox",
  description: "Convert images to Excel spreadsheets. This feature is currently under development. Check back soon for updates.",
};
    ...
    <div className="container mx-auto px-4 py-16 max-w-4xl">
      ...
      <div className="text-center mb-12">
        ...
        <p className="text-xl text-muted-foreground max-w-2xl mx-auto">
          This feature is currently under development. We&apos;re working hard to bring you a powerful tool that converts images to Excel spreadsheets.
        </p>
      </div>
        ...
        <CardContent>
          <ul className="space-y-3 text-muted-foreground">
            <li className="flex items-start gap-3">
              ...
              <span>Upload images containing tables or data</span>
            </li>
            <li className="flex items-start gap-3">
              <div className="w-5 h-5 rounded-full bg-[#1D6F42] text-white flex items-center justify-center shrink-0 mt-0.5 text-xs">
                ✓
              </div>
              <span>Automatic OCR and table detection</span>
            </li>
            <li className="flex items-start gap-3">
              <div className="w-5 h-5 rounded-full bg-[#1D6F42] text-white flex items-center justify-center shrink-0 mt-0.5 text-xs">
                ✓
              </div>
              <span>Export to Excel format (.xlsx)</span>
            </li>
            <li className="flex items-start gap-3">
              <div className="w-5 h-5 rounded-full bg-[#1D6F42] text-white flex items-center justify-center shrink-0 mt-0.5 text-xs">
                ✓
              </div>
              <span>100% browser-based processing - your images never leave your device</span>
            </li>
          </ul>
        </CardContent>
      </Card>
